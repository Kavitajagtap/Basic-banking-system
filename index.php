    ...
    <div class="container-fluid px-lg-5">
      <nav class="navbar navbar-expand-lg my-navbar">
         <a class="navbar-brand" href="index.php"><span class="logo1">
             <img height="60" width ="70" src = "img/icon.png" class ="img-fluid1">&nbsp;<span id = "lg">SPARKS BANK</span></span>
         </a>
    ...
    <div class="col-sm-12 col-md">
                  ...
                  <div class = "box">
                   <center>
                    <a href="view_customer.php">
                     <img src = "img/user.jpg" class = "logo">
                   ...
                   <div class = "box">
                    <center>
                      <a href="transfer_money.php">
                       <img src = "img/transfer.jpg" class = "logo">
                 ...
                 <div class = "box">
                   <center>
                    <a href="transaction_history.php">
                     <img src = "img/history.jpg" class = "logo">
      ...
      <a name = "about"></a>
          ...
          <div class="col-sm-12 col-md img text-center">
           <img width = "382" height ="272" src="img/pic1.png" class="img-fluid pt-2">
       </div>
      </div>
 </div>
...
<section>
  ...
  <section>
    ...
    <h1 style = "text-align: center;color:black; margin-top: -60px;" class="heading"><a name = "contact">Contact Us</a></h1>
    <div class="container">
                  ...
                  <div class="controls">
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          <input type="submit" name="ok" style = "margin-left:25%;"class="btn btn-1 btn-send" value="Send message">
                        </div>
                      </div>
                    </div>
                </form>
  ...
  <footer class="text-center mt-4 py-2">
        <p>&copy 2021 All Rights are Reserved &nbsp;&nbsp;made by <b>KAVITA JAGTAP</b> <br> The Sparks Foundation</p>
  </footer>
